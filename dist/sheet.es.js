...
import { CloseIcon as f } from "./closeicon.es.js";
...
const N = r.forwardRef(({ className: t, ...a }, s) => /* @__PURE__ */ o(e.Description, { ref: s, className: i("text-sm text-muted-foreground", t), ...a }));
